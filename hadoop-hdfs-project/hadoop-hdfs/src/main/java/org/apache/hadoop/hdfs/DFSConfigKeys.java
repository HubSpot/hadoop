...
public class DFSConfigKeys extends CommonConfigurationKeys {
  ...
  public static final String DFS_DATANODE_BLOCK_ACCESS_TOKEN_UNSAFE_ALLOWED_NOT_REQUIRED_KEY = "dfs.datanode.block.access.token.unsafe.allowed-not-required";
  public static final boolean DFS_DATANODE_BLOCK_ACCESS_TOKEN_UNSAFE_ALLOWED_NOT_REQUIRED_DEFAULT = false;
